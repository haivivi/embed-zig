...
function(esp_zig_build)
    ...
    # Write ESP-IDF include dirs to a file (avoids command line expansion issues)
    # Generator expression resolves at build time
    file(GENERATE OUTPUT "${CMAKE_CURRENT_SOURCE_DIR}/esp_include_dirs.txt"
        CONTENT "${ESP_INCLUDE_DIRS}")
    
    # zig build-lib: called via zig_build.sh (generated by Bazel esp_zig_app)
