...
pub fn build(b: *std.Build) void {
    ...
    const x_proto_dep = b.dependency("x_proto", .{ .target = target, .optimize = optimize });
    ...
    const channel_dep = b.dependency("channel", .{ .target = target, .optimize = optimize });
    ...
    app_module.addImport("x_proto", x_proto_dep.module("x_proto"));
