...
# Find bootstrap/esp version
file(GLOB _ESPRESSIF_DIRS "${_ZIG_REPO_ROOT}/bootstrap/esp/*")
list(SORT _ESPRESSIF_DIRS ORDER DESCENDING)

if(NOT _ESPRESSIF_DIRS)
    message(FATAL_ERROR "[zig_install] No bootstrap/esp/* directory found")
endif()

list(GET _ESPRESSIF_DIRS 0 _ESPRESSIF_DIR)
get_filename_component(ESPRESSIF_VERSION "${_ESPRESSIF_DIR}" NAME)
message(STATUS "[zig_install] Using Zig version: ${ESPRESSIF_VERSION}")
