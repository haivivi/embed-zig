...
Provides:
- Audio libraries (opus, ogg, speexdsp, portaudio)
...
load("//third_party/portaudio:repository.bzl", _portaudio_repository = "portaudio_repo")
...
def _audio_libs_impl(ctx):
    ...
    _portaudio_repository(name = "portaudio")
