...
pub fn build(b: *std.Build) void {
    ...
    // mqtt0 module
    const mqtt0_mod = b.addModule("net/mqtt0", .{
    ...
    integration_test.root_module.addImport("net/mqtt0", mqtt0_mod);
    ...
    zig_client.root_module.addImport("net/mqtt0", mqtt0_mod);
    ...
    zig_broker.root_module.addImport("net/mqtt0", mqtt0_mod);
    ...
    bench.root_module.addImport("net/mqtt0", mqtt0_mod);
