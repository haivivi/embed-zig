...
//!     pub fn schedule(self: *TimerService, delay_ms: u32, callback: TaskFn, ctx: ?*anyopaque) TimerHandle;
//!     pub fn cancel(self: *TimerService, handle: TimerHandle) void;
//! };
//! ```
//!
//! Types (TimerHandle, etc.) and implementations live in `lib/pkg/timer`.
//! This module only validates the comptime contract.
//!
//! ## Usage
//!
//! ```zig
...
///
/// Required:
/// - `schedule(*Impl, u32, TaskFn, ?*anyopaque) TimerHandle`
