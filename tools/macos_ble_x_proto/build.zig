...
pub fn build(b: *std.Build) void {
    ...
    const x_proto_mod = b.createModule(.{
        .root_source_file = b.path("../../lib/pkg/x_proto/src/x_proto.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    root_mod.addImport("x_proto", x_proto_mod);

    const exe = b.addExecutable(.{
        .name = "macos_ble_x_proto",
    ...
    const run_step = b.step("run", "Run macOS BLE x_proto test");
